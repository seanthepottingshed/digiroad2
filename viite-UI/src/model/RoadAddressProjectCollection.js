(function(root) {
  root.RoadAddressProjectCollection = function(backend) {
    ...
    this.checkIfReserved = function (data) {
      return backend.checkIfRoadpartReserved(data[1].value, data[3].value === '' ? 0 : parseInt(data[3].value), data[4].value === '' ? 0 : parseInt(data[4].value), data[5].value === '' ? 0 : parseInt(data[5].value))
